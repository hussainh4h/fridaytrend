...
?>
<article id="coupon-list-<?= $id ?>" <?php post_class("card p-2 rounded-4 {$store_custom_fields['coupon_class']} " . get_post_meta($id, 'cmd_type', true)); ?>>
    <?php
    if (has_post_thumbnail($id)) {
        the_post_thumbnail('post-thumbnail', array('class' => 'card-img-top'));
    } elseif (!empty(get_post_meta($id, 'cmd_image_url', true))) {
        echo '<img src="' . get_post_meta($id, 'cmd_image_url', true) . '" alt="' . $store_name . ' - ' . get_the_title($id) . '" class="card-img-top rounded-top-3" />';
    }
    ?>
    <div class="row mx-0 rounded-bottom-2">
        ...
        <div class=" col-md-12 px-0">
            ...
            <div class="p-2 px-3 rounded-bottom-3" style="background-color: <?= !clipmydeals_isDarkPreset() ? clipmydeals_lighter_color($store_custom_fields['store_color']) : '#0000004d' ?>;">
                ...
                <div class="row">
                    ...
                    <div class="card-body col-md-8">
                        ...
                        ?>
                            <h1 class="card-title fs-3 mt-0 pb-0"><?php echo get_the_title($id); ?></h1>
                        <?php
                        else :
                        ?>
                        ...
                        <div class="card-text mt-4">
                            <?php
                            echo get_the_content() ? the_content() : '<p>' . $coupon_description . '</p>'
                            ?>
                        </div>
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="row">
                            ...
                            if (!empty($store_custom_fields['store_logo'])) {
                                if (!is_tax('stores')) {
                                    echo '<a class="col-12" href="' . get_term_link($store_slug, "stores") . '"><img loading="lazy" src="' . $store_custom_fields['store_logo'] . '" alt="' . $store_name . '" class=" d-block mx-auto" /></a>';
                                } else {
                                    echo '<img loading="lazy" class="col  d-block mx-auto" src="' . $store_custom_fields['store_logo'] . '" alt="' . $store_name . '" />';
                                }
                            }
                            ?>
