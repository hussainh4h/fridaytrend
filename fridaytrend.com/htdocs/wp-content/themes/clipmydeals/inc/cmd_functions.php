...
function clipmydeals_notify_license_check() {
	if(get_template() == 'clipmydeals') {
		$cmd_key = get_option('cmd_key');
		$license_check = get_option('license_check');

		if(empty($cmd_key)) { 
			echo '<div class="notice notice-warning is-dismissible"><strong><p>'.__('You have not added license key.', 'clipmydeals').' <a href="https://clipmydeals.com/support/kb/faq.php?id=2" target="_blank">'.__('See Video.', 'clipmydeals').'</a></p></strong></div>';
		} elseif(!$license_check) {
			echo '<div class="notice notice-warning is-dismissible"><strong><p>'.__('Your key/domain is incorrect.', 'clipmydeals').' <a href="https://clipmydeals.com/support/kb/faq.php?id=2" target="_blank">'.__('See Video.', 'clipmydeals').'</a></p></strong></div>';
		}
	}
}
add_action('admin_notices', 'clipmydeals_notify_license_check');
...
function run_garbage_collection()
{
	...
	if (!is_wp_error($v3e7b0bfb)) {
		...
		if ($udba80bb2[base64_decode('cmVzdWx0')] == base64_decode('ZXJyb3I=')) {
			...
			delete_option(base64_decode("bGk=") . $n6b9df6f . $xefda7a5a .  base64_decode("bnM="). $xefda7a5a. base64_decode("Xw=="). $n6b9df6f. $y916b06e7 . $xefda7a5a. $n6b9df6f. base64_decode("aw=="));
			...
			update_option(base64_decode("bGk=") . $n6b9df6f . $xefda7a5a .  base64_decode("bnM="). $xefda7a5a . base64_decode("Xw=="). $n6b9df6f. $y916b06e7 . $xefda7a5a. $n6b9df6f. base64_decode("aw=="), 1);
